...
function Clock() {
    ...
    const start = () => {
        let id = window.setInterval(()=>{setDate(new Date())}, 1000)
        setTimerId(id)
    ...
    const stringTime = new Intl.DateTimeFormat('ru', {hour: "2-digit", minute: "numeric", second: "numeric"}).format(date) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
